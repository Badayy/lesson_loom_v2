		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xl-12">
						...
						<div class="card-body">
							<div class="d-flex justify-content-between">
								<div class="user">
									...
									<div>
										<h2 class="mb-0">Cordova Central Elementary School</h2>
										<p class="text-primary font-w600">CCES</p>
									</div>
								</div>
								<div class="dropdown custom-dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item text-primary" href="school-edit-profile.php">Edit</a>
					...
					<div class="card h-auto">
						<div class="card-header border-0 p-3">
							<h4 class="heading mb-0">Teacher Registered</h4>
						</div>
							...
							<div class="table-responsive full-data">
								<table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
									...
									<tbody>
										<tr>
											<td>
												<span class="text-primary font-w600">123456789</span>
											</td>
											<td>
				...
				<div class="col-xl-12">
					<div class="card h-auto">
						<div class="card-header border-0 p-3">
							<h4 class="heading mb-0">Certificate's</h4>
						</div>
