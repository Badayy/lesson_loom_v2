                                                        ...
                                                        <td>
                                                            <div class="dropdown custom-dropdown float-end">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <a class="dropdown-item text-danger" href="javascript:void(0);">Leave</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
            ...
            <div class="modal-dialog modal-dialog-center">
                <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="C O D E" name="classcode" required>
                                </div>  
                            </div>	
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary">Join Class</button>
                    </div>
                    </form>
                </div>
            </div>
