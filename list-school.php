						...
						<div class="row">
							...
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="card contact_list text-center">
										...
										<div class="user-content">
											<div class="user-info">
												...
												<div class="user-details">
													<h4 class="user-name mb-0">Cordova Central Schools</h4>
													<p>CCS</p>
												</div>
											</div>
											<div class="dropdown">
										...
										<div class="contact-icon">
											<span class="badge badge-success light">Activate</span>
										</div>
										<div class="d-flex justify-content-center align-items-center">
											<a href="school-detail.php" class="btn  btn-primary btn-sm w-50 me-2 float-center"><i class="fa-solid fa-user me-2"></i>Profile</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-lg-4 col-sm-6">
								<div class="card contact_list text-center">
										...
										<div class="contact-icon">
											<span class="badge badge-danger light">Deactivate</span>
										</div>
										<div class="d-flex justify-content-center align-items-center">
											<a href="school-detail.php" class="btn  btn-primary btn-sm w-50 me-2 float-center"><i class="fa-solid fa-user me-2"></i>Profile</a>
										</div>
			...
			<div class="col-xl-12">
				<div class="card">
					<div class="card-header border-0 p-3">
						<h4 class="heading mb-0">List of Rejected School</h4>
					</div>
