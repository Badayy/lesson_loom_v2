						...
						<div class="card card-bx profile-card author-profile m-b30">
							<form action="">
								<div class="card-body">
									<div class="p-5">
										<div class="author-profile">
											...
											<div class="author-info">
												<h6 class="title">Complete Name</h6>
												<span>Teacher</span>
											</div>
										</div>
									</div>
									<div class="info-list">
										<ul>
											<li>First Name<span>Maria</span></li>
											<li>Last Name<span>Juan</span></li>
											<li>Email<span>Maria@email.com</span></li>
											<li>Birthday<span>August 67, 2929</span></li>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-6 m-b30">
										...
										<input type="text" class="form-control" value="Maria" name="fname">
									</div>
									<div class="col-sm-6 m-b30">
										<label class="form-label">Last Name</label>
										<input type="text" class="form-control" value="Juan" name="lname">
									</div>
									<div class="col-sm-6 m-b30">
									...
									<div class="col-sm-6 m-b30">
										...
										<input type="date" class="form-control" name="birthday" value="August 67, 2929">
									</div>
									<div class="col-sm-6 m-b30">
									...
									<div class="col-sm-6 m-b30">
										...
										<input type="text" class="form-control" value="Maria@gmail.com" name="email">
									</div>
									<div class="col-sm-6 m-b30">
