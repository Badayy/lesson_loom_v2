							...
							<div class="d-flex justify-content-between">
								...
								<div class="dropdown custom-dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item text-primary" href="teacher-edit-profile.php">Edit</a>
										<a class="dropdown-item text-danger" >Deactivate</a>
									</div>
								</div>
							</div>	
							<div class="row mt-2">
								...
								<div class="col-xl-3 col-xxl-6 col-sm-6 mt-5">
									<ul class="student-details">
										<li class="me-2">
											<a class="icon-box bg-secondary">
												<i class="fa-solid fa-cake-candles text-white" style="font-size: 0.6em;"></i>
											</a>	
										
										</li>
										<li><span>Birthday:</span><h5 class="mb-0">09/23/1993</h5></li>
									</ul>
								</div>
								<div class="col-xl-3 col-xxl-6 col-sm-6 mt-5">
									<ul class="student-details">
										<li class="me-2">
											<a class="icon-box bg-secondary">
												<i class="fa-solid fa-venus-mars text-white" style="font-size: 0.6em;"></i>
											</a>	
										
										</li>
										<li><span>Gender:</span><h5 class="mb-0">Female</h5></li>
									</ul>
								</div>
							</div>
				...
				<div class="col-xl-12">
					<div class="card h-auto">
						<div class="card-header border-0 p-3">
							<h4 class="heading mb-0">ID's</h4>
						</div>
						<div class="card-body p-5">
							<div class="row justify-content-center">
								<div class="col-4">
									<img src="https://via.placeholder.com/500" alt="Image 2" class="img-fluid fixed-size-img">
								</div>
								<div class="col-4">
									<img src="https://via.placeholder.com/500" alt="Image 3" class="img-fluid fixed-size-img">
								</div>
							</div>
